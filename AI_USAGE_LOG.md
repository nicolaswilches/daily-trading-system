...
| **UI/UX Design** | Injected custom CSS to implement an Anthropic-inspired minimal aesthetic. | Created a professional, institutional-grade dashboard without standard Streamlit defaults. |
